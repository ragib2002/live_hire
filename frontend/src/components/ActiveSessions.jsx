        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
          {isLoading ? (
            ...
            sessions.map((session) => {
              ...
              const totalCapacity = participantCount + 1; // +1 for the host
                ...
                >
                  <div className="flex items-center justify-between gap-4 p-5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-sm opacity-80">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs">{totalCapacity} invited</span>
                          </div>
                    ...
                    {isUserInSession(session) ? (
                      ...
                      <button className="btn btn-disabled btn-sm">Not Invited</button>
                    )}
                  </div>
                </div>
              );
            ...
            <div className="text-center py-16">
              ...
              <p className="text-sm opacity-50">You're not invited to any active sessions</p>
            </div>
          )}
        </div>
      </div>
